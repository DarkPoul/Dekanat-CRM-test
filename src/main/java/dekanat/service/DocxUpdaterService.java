...
public class DocxUpdaterService {

    public DocxUpdaterService(){};

    public void DocxUpdater() {
        ...
        List<Student> students = List.of(
                ...
                new Student(20, "Петров Петро Петрович", "234567", 48),
                new Student(21, "Сидорова Марія Олександрівна", "345678", 60),
                new Student(22, "Іванов Іван Іванович", "123456", 55)
        ...
        try (FileInputStream fis = new FileInputStream(inputFilePath);
            ...
            if (students.size() <= 19){
                XWPFTable table3 = tables.get(2);
                int pos = document.getBodyElements().indexOf(table3);
        ...
        for (XWPFParagraph paragraph : body.getParagraphs()) {
            for (XWPFRun run : paragraph.getRuns()) {
                ...
                if (text != null) {
                    ...
                    text = text.replace("{tI}", "Клочан А. Є.");
